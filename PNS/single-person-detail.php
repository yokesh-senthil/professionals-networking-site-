...
<div class="listing-contact-table-field">
										...
										<div class="listing-contact-table-field">
											<ul>
												...
												<li class="details" ><a style="color:green;font-size:20px;" href="https://api.whatsapp.com/send?phone=<?php  echo $row->MobileNumber;?>&text=Hello">Click here => Send message on WhatsApp</a></li>
										...
										<div class="listing-contact-table-field">
											<ul>
												<li class="info" style="font-weight:bold">Working Experience(in Years):</li>
												<li class="details"><?php  echo $row->exp;?></li>
											</ul>
										</div>
										<div class="listing-contact-table-field">
											
												<p>Sample image of their work:</p><br>
												<img src="admin/images/<?php echo $row->workimage;?>" height="195" width="300" alt="listing item"/>
											
										</div>
										<div class="listing-contact-table-field">
											
												<p>Licenses or Certification:</p><br>
												<img src="admin/images/<?php echo $row->certification;?>" height="195" width="300" alt="listing item"/>
												<a download href="admin/images/<?php echo $row->certification;?>" style="color:blue;font-size:20px;">=>Download the certification</a>
