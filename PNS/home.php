			...
			<div class="fullwidthbanner-container">
				<div class="revolution-slider tx-center">
					<ul><!-- SLIDE  -->
						...
						<!-- MAIN IMAGE -->
							<img src="images/banner1.jpg" alt="item slide">
						<!-- LAYERS -->	
				...
				<div class="search-form-wrap">
					<form class="clearfix" name="search" action="serviceman-search.php" method="post">
						...
						<div class="select-field-wrap pull-left">
							...
							<h6>Select Your needed Service and Your location =></h6>	
...
<option value="<?php echo htmlentities($row->Category);?>"><?php echo htmlentities($row->Category);?></option>
 <?php } ?> 
		...
		<select class="search-form-select" name="location" >
			   <option  value="All-locations">Available Locations</option>
			   <?php 

$sql3 = "SELECT DISTINCT City from   tblperson ";
...
{          
?>  
<option value="<?php echo htmlentities($row1->City);?>"><?php echo htmlentities($row1->City);?></option>
<?php } ?> 
		   </select>
	                    </div>
		...
		<section class="categories-section padding-top-20 padding-bottom-40">
			...
			<div>
			    <h2>Find your desired services like...</h2><br><br>
			    <table>
				   <tr>
					<td>
						<img src="images/carpenter.jpg" alt="" width=310px height=280px>
						<h4>Carpenter</h4>
    				</td>
					<td>
						<img src="images/driver.jpg"alt=""width=310px height=280px>
						<h4>Driver</h4>
    				</td>
					<td>
						<img src="images/painter.jpg"alt=""width=310px height=280px>
						<h4>Painter</h4>
    				</td>
				  </tr>
				  <tr>
					<td>
						<img src="images/electrician.jpeg"alt="" width=310px height=280px>
						<h4>Electrician</h4>
    				</td>
					<td>
						<img src="images/mechanic.jpg"alt="" width=310px height=280px>
						<h4>Mechanic</h4>
    				</td>
					<td>
						<img src="images/plumber.jpg"alt="" width=310px height=280px>
						<h4>Plumber</h4>
    				</td>
				  </tr><br><br>
